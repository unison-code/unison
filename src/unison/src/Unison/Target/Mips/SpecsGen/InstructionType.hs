...
instructionType i
  ...
  | i `elem`
      [ABSQ_S_PH, ABSQ_S_PH_MM, ABSQ_S_QB, ABSQ_S_QB_MMR2, ABSQ_S_W,
       ...
       AndRxRxRy16, BADDu, BALIGN, BCLRI_B, BCLRI_D, BCLRI_H, BCLRI_W,
       BCLR_B, BCLR_D, BCLR_H, BCLR_W, BGE, BGEImmMacro, BGEL,
       ...
       B_MM_Pseudo, BeqImm, BneImm, Break16, BuildPairF64,
       ...
       SWL, SWL64, SWLE, SWLE_MM, SWL_MM, SWM16_MM, SWM16_MMR6, SWM32_MM,
       SWM_MM, SWP_MM, SWR, SWR64, SWRE, SWRE_MM, SWR_MM, SWSP_MM,
       SWSP_MMR6, SWXC1, SWXC1_MM, SW_MM, SW_MMR6, SW_fi, SYNC, SYNCI,
