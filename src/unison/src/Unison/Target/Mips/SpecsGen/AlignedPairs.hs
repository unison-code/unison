...
alignedPairs i ([_], [_])
  | i `elem`
      [CEIL_L_D64, CEIL_L_S, CEIL_W_D32, CEIL_W_D64, CEIL_W_MM, CEIL_W_S,
       ...
       FSQRT_D64, FSQRT_MM, FSQRT_S, FSQRT_S_MM, PseudoCVT_D32_W,
       PseudoCVT_D64_L, PseudoCVT_D64_W, PseudoCVT_S_L, PseudoCVT_S_W,
       RINT_D, RINT_D_MMR6, RINT_S, RINT_S_MMR6, ROUND_L_D64, ROUND_L_S,
       ROUND_W_D32, ROUND_W_D64, ROUND_W_MM, ROUND_W_S, ROUND_W_S_MM,
       TRUNC_L_D64, TRUNC_L_S, TRUNC_W_D32, TRUNC_W_D64, TRUNC_W_MM,
       TRUNC_W_S, TRUNC_W_S_MM]
    = []
alignedPairs i ([_], [_])
  | i `elem`
...
alignedPairs i ([_], [_])
  | i `elem`
      [ABSQ_S_PH, ABSQ_S_QB, ABSQ_S_W, BITREV, BITSWAP, BITSWAP_MMR6,
       ...
       MOVE_D, MOVE_F, PRECEQU_PH_QBL, PRECEQU_PH_QBLA, PRECEQU_PH_QBR,
       PRECEQU_PH_QBRA, PRECEQ_W_PHL, PRECEQ_W_PHR, PRECEU_PH_QBL,
       PRECEU_PH_QBLA, PRECEU_PH_QBR, PRECEU_PH_QBRA, REPLV_PH, REPLV_QB,
