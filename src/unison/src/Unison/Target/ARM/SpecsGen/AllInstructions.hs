...
allInstructions
  = [ABS, ADCri, ADCrr, ADCrsi, ADCrsr, ADDSri, ADDSrr, ADDSrsi,
     ...
     TADDhirrs, TORRs, TBICs, TUXTBz, TMVNs, TANDs, TUXTHz, TEORs,
     TSXTHz, TLSRrrs, TLDRSHz, TLDRSBz, TLDRHrz, TSTRHrz, TSTRrz,
     ...
     TTST_cpsr, T2TEQrr_cpsr, TPUSHcs, TPOPcs, TPOPcs_free, MEMCPY_4,
     T2LDMIA_4, T2LDMIA_UPD_4, T2STMIA_4, T2STMIA_UPD_4]
