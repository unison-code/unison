...
allInstructions
  = [ABS, ADCri, ADCrr, ADCrsi, ADCrsr, ADDSri, ADDSrr, ADDSrsi,
     ...
     VLDRD_fi, VLDRS_fi, VLDRD_cpi, VLDRS_cpi, MOVE, MOVE_ALL, MOVE_D,
     STORE, STORE_T, STORE_D, LOAD, LOAD_T, LOAD_D, NOP, TMOVi8s,
     TLSLris, TASRris, TLSRris, TSUBi3s, TSUBi8s, TADDi8s, TMULz,
     TADDi3s, TRSBs, TLSLrrs, TASRrrs, TSUBrrs, TADDrrs, TADDhirrs,
     TORRs, TBICs, TUXTBz, TMVNs, TANDs, TUXTHz, TEORs, TSXTHz, TLSRrrs,
     TLDRSHz, TLDRHrz, TSTRHrz, TSTRrz, TLDRBrz, TSTRBrz, TLDRrz,
     TCMPi8_cpsr, T2CMPri_cpsr, T2TSTri_cpsr, T2CMNri_cpsr,
     T2CMPrr_cpsr, T2TSTrr_cpsr, T2CMPrs_cpsr, T2TSTrs_cpsr,
     T2SUBrr_cpsr, T2SUBri_cpsr, T2ORRrr_cpsr, T2ANDri_cpsr,
     T2ADDri_cpsr, FMSTAT_cpsr, TCMPr_cpsr, TCMPhir_cpsr, TTST_cpsr,
     T2TEQrr_cpsr, TPUSHcs, TPOPcs, TPOPcs_free]
