...
allInstructions
  = [ABS, ADCri, ADCrr, ADCrsi, ADCrsr, ADDSri, ADDSrr, ADDSrsi,
     ...
     TCMPr, TCPS, TEOR, THINT, THLT, TInt_eh_sjlj_longjmp,
     ...
     TLSLri, TLSLrr, TLSRri, TLSRrr, TMOVCCr_pseudo, TMOVSr, TMOVi8,
     TMOVr, TMUL, TMVN, TORR, TPICADD, TPOP, TPOP_RET, TPUSH, TREV,
     TREV16, TREVSH, TROR, TRSB, TSBC, TSETEND, TSTMIA_UPD, TSTRBi,
     TSTRBr, TSTRHi, TSTRHr, TSTRi, TSTRr, TSTRspi, TSUBi3, TSUBi8,
     TSUBrr, TSUBspi, TSVC, TSXTB, TSXTH, TTAILJMPd, TTAILJMPdND,
     TTAILJMPr, TTPsoft, TTRAP, TTST, TUDF, TUXTB, TUXTH, T2ADDri_fi,
     T2LDRi12_fi, T2LDRBi12_fi, T2LDRHi12_fi, T2LDRSHi12_fi,
     T2STRHi12_fi, T2STRi12_fi, T2STRBi12_fi, VSTRS_fi, VLDRD_fi,
     VLDRS_fi, VLDRD_cpi, VLDRS_cpi, MOVE, MOVE_ALL, MOVE_D, STORE,
     STORE_T, STORE_D, LOAD, LOAD_T, LOAD_D, NOP, TMOVi8s, TLSLris,
     TASRris, TLSRris, TSUBi3s, TSUBi8s, TADDi8s, TMULz, TADDi3s, TRSBs,
     TLSLrrs, TASRrrs, TSUBrrs, TADDrrs, TADDhirrs, TORRs, TBICs,
     TUXTBz, TMVNs, TANDs, TUXTHz, TEORs, TSXTHz, TLSRrrs, TLDRSHz,
     TLDRHrz, TSTRHrz, TSTRrz, TLDRBrz, TSTRBrz, TLDRrz, TCMPi8_cpsr,
     T2CMPri_cpsr, T2TSTri_cpsr, T2CMNri_cpsr, T2CMPrr_cpsr,
     T2TSTrr_cpsr, T2CMPrs_cpsr, T2TSTrs_cpsr, T2SUBrr_cpsr,
     T2SUBri_cpsr, T2ORRrr_cpsr, T2ANDri_cpsr, T2ADDri_cpsr,
     FMSTAT_cpsr, TCMPr_cpsr, TCMPhir_cpsr, TTST_cpsr, T2TEQrr_cpsr,
     TPUSHcs, TPOPcs, TPOPcs_free]
