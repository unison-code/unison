...
readWriteInfo i
  | i `elem`
      [ADDri, ADDrr, ADDrsi, ADDrsr, ADR, AESD, AESE, AESIMC, AESMC,
       ...
       T2ADDri12, T2ADDri_cpsr, T2ADDri_fi, T2ADDrr, T2ADDrs, T2ADR,
       ...
       T2LDC_POST, T2LDC_PRE, T2LDRBT, T2LDRBi12, T2LDRBi12_fi, T2LDRBi8,
       T2LDRBpci, T2LDRBpcrel, T2LDRBs, T2LDRHT, T2LDRHi12, T2LDRHi12_fi,
       T2LDRHi8, T2LDRHpci, T2LDRHpcrel, T2LDRHs, T2LDRSBT, T2LDRSBi12,
       T2LDRSBi8, T2LDRSBpci, T2LDRSBpcrel, T2LDRSBs, T2LDRSHT,
       T2LDRSHi12, T2LDRSHi12_fi, T2LDRSHi8, T2LDRSHpci, T2LDRSHpcrel,
       T2LDRSHs, T2LDRT, T2LDRi12, T2LDRi12_fi, T2LDRi8, T2LDRpci,
       ...
       T2MOVsr, T2MRC, T2MRC2, T2MRRC, T2MRRC2, T2MRS_AR, T2MRS_M,
