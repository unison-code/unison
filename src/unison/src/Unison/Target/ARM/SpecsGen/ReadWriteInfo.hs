...
readWriteInfo i
  | i `elem`
      [ADDri, ADDrr, ADDrsi, ADDrsr, ADR, AESD, AESE, AESIMC, AESMC,
       ...
       VZIPd16, VZIPd8, VZIPq16, VZIPq32, VZIPq8, Load_merge,
       Register_class_decl_dummy, T2ADDri, T2ADDri12, T2ADDri_cpsr,
       T2ADDri_fi, T2ADDri_fi_demat_fi, T2ADDri_fi_remat_fi,
       T2ADDri_fi_source_fi, T2ADDricc, T2ADDrr, T2ADDrrcc, T2ADDrs,
       T2ADDrscc, T2ADR, T2ANDri, T2ANDri_cpsr, T2ANDricc, T2ANDrr,
       T2ANDrs, T2ASRri, T2ASRrr, T2B, T2BFC, T2BFI, T2BICri, T2BICrr,
       T2BICrs, T2BR_JT, T2BXJ, T2Bcc, T2CDP, T2CDP2, T2CLREX, T2CLZ,
       T2CMNri_cpsr, T2CMPri_cpsr, T2CMPrr_cpsr, T2CMPrs_cpsr, T2CPS1p,
       T2CPS2p, T2CPS3p, T2CRC32B, T2CRC32CB, T2CRC32CH, T2CRC32CW,
       T2CRC32H, T2CRC32W, T2DBG, T2DCPS1, T2DCPS2, T2DCPS3, T2DMB, T2DSB,
       T2EORri, T2EORrr, T2EORrs, T2HINT, T2HVC, T2ISB, T2LDA, T2LDAB,
       ...
       T2LDC_OFFSET, T2LDC_OPTION, T2LDC_POST, T2LDC_PRE, T2LDRBT,
       T2LDRBi12, T2LDRBi12_fi, T2LDRBi12_fi_demat_fi,
