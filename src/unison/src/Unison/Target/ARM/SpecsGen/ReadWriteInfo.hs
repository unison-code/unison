...
readWriteInfo i
  | i `elem`
      [ADDri, ADDrr, ADDrsi, ADDrsr, ADR, AESD, AESE, AESIMC, AESMC,
       ...
       T2LSLricc, T2LSLrr, T2LSRri, T2LSRrr, T2MCR, T2MCR2, T2MCRR,
       T2MCRR2, T2MLA, T2MLS, T2MOVCCasr, T2MOVCCi, T2MOVCCi16,
       T2MOVCCi32imm, T2MOVCClsl, T2MOVCClsr, T2MOVCCr, T2MOVCCror,
       T2MOVSsi, T2MOVSsr, T2MOVTi16, T2MOVTi16_ga_pcrel, T2MOV_ga_pcrel,
       T2MOVi, T2MOVi16, T2MOVi16_demat, T2MOVi16_ga_pcrel,
       T2MOVi16_remat, T2MOVi16_source, T2MOVi32imm, T2MOVi32imm_demat,
       T2MOVi32imm_remat, T2MOVi32imm_source, T2MOVi_demat, T2MOVi_remat,
       T2MOVi_source, T2MOVr, T2MOVsi, T2MOVsr, T2MRC, T2MRC2, T2MRRC,
       T2MRRC2, T2MRS_AR, T2MRS_M, T2MRSbanked, T2MRSsys_AR, T2MSR_AR,
       T2MSR_M, T2MSRbanked, T2MUL, T2MVNCCi, T2MVNi, T2MVNi_demat,
       T2MVNi_remat, T2MVNi_source, T2MVNr, T2MVNs, T2ORNri, T2ORNrr,
       T2ORNrs, T2ORRri, T2ORRrr, T2ORRrr_cpsr, T2ORRrs, T2PKHBT, T2PKHTB,
       ...
       T2RFEIAW, T2RORri, T2RORrr, T2RSBri, T2RSBrr, T2RSBrs, T2SADD16,
       T2SADD8, T2SASX, T2SBFX, T2SDIV, T2SEL, T2SETPAN, T2SHADD16,
       ...
       T2STLH, T2STRBT, T2STRB_POST, T2STRB_preidx, T2STRBi12,
       T2STRBi12_fi, T2STRBi8, T2STRBs, T2STRHT, T2STRH_POST,
