...
instructionType i
  | i `elem`
      [B, BCCZi64, BCCi64, BR_JTadd, BR_JTm, BR_JTr, BX, BXJ, BX_RET,
       ...
       T2BR_JT, T2Bcc, T2LDMIA_RET, T2LDMIA_RET_4_10, T2LDMIA_RET_4_11,
       T2LDMIA_RET_4_8, T2LDMIA_RET_4_9, T2SUBS_PC_LR, T2TBB, T2TBB_JT,
       T2TBH, T2TBH_JT, TB, TBRIND, TBR_JTr, TBX, TBX_RET, TBX_RET_vararg,
       TBcc, TBfar, TCBNZ, TCBZ, TPOP_RET, TPOP_RET_4, TPOP_RET_4_5,
  ...
  | i `elem`
      [ABS, ADCri, ADCrr, ADCrsi, ADCrsr, ADDSri, ADDSrr, ADDSrsi,
       ...
       HINT, HLT, IMPLICIT_DEF, INLINEASM, INSERT_SUBREG, ISB, ITasm,
       ...
       VLDRD_fi_source_fi, VLDRS, VLDRS_cpi, VLDRS_cpi_source_cpi,
       VLDRS_fi, VLDRS_fi_source_fi, VMAXNMD, VMAXNMNDf, VMAXNMNDh,
       ...
       Load_merge, Register_class_decl_dummy, SysLDMDA, SysLDMDA_UPD,
       SysLDMDB, SysLDMDB_UPD, SysLDMIA, SysLDMIA_UPD, SysLDMIB,
       SysLDMIB_UPD, SysSTMDA, SysSTMDA_UPD, SysSTMDB, SysSTMDB_UPD,
       SysSTMIA, SysSTMIA_UPD, SysSTMIB, SysSTMIB_UPD, T2ABS, T2ADCri,
       T2ADCrr, T2ADCrs, T2ADDSri, T2ADDSrr, T2ADDSrs, T2ADDri, T2ADDri12,
       T2ADDri_cpsr, T2ADDri_fi, T2ADDri_fi_source_fi, T2ADDricc, T2ADDrr,
       T2ADDrrcc, T2ADDrs, T2ADDrscc, T2ADR, T2ANDri, T2ANDri_cpsr,
       T2ANDricc, T2ANDrr, T2ANDrs, T2ASRri, T2ASRrr, T2BFC, T2BFI,
       T2BICri, T2BICrr, T2BICrs, T2BXJ, T2CDP, T2CDP2, T2CLREX, T2CLZ,
       T2CMNri, T2CMNri_cpsr, T2CMNzrr, T2CMNzrs, T2CMPri, T2CMPri_cpsr,
       T2CMPrr, T2CMPrr_cpsr, T2CMPrs, T2CMPrs_cpsr, T2CPS1p, T2CPS2p,
       T2CPS3p, T2CRC32B, T2CRC32CB, T2CRC32CH, T2CRC32CW, T2CRC32H,
       T2CRC32W, T2DBG, T2DCPS1, T2DCPS2, T2DCPS3, T2DMB, T2DSB, T2EORri,
       T2EORrr, T2EORrs, T2HINT, T2ISB, T2IT, T2Int_eh_sjlj_setjmp,
       ...
       T2LDMDB, T2LDMDB_UPD, T2LDMIA, T2LDMIA_4, T2LDMIA_UPD,
       ...
       T2LDRBi12_fi, T2LDRBi12_fi_source_fi, T2LDRBi8, T2LDRBpci,
       ...
       T2MOVi, T2MOVi16, T2MOVi16_ga_pcrel, T2MOVi16_source, T2MOVi32imm,
       T2MOVi32imm_source, T2MOVi_source, T2MOVr, T2MOVsi, T2MOVsr,
       T2MOVsra_flag, T2MOVsrl_flag, T2MRC, T2MRC2, T2MRRC, T2MRRC2,
       T2MRS_AR, T2MRS_M, T2MRSbanked, T2MRSsys_AR, T2MSR_AR, T2MSR_M,
       T2MSRbanked, T2MUL, T2MVNCCi, T2MVNi, T2MVNi_source, T2MVNr,
       T2MVNs, T2ORNri, T2ORNrr, T2ORNrs, T2ORRri, T2ORRricc, T2ORRrr,
       ...
       TMOVi8, TMOVi8s, TMOVi8s_source, TMOVr, TMUL, TMULz, TMVN, TMVNs,
       TORR, TORRs, TPICADD, TPOP, TPUSH, TPUSH_4, TPUSH_4_5, TPUSH_4_6,
       TPUSH_4_7, TREV, TREV16, TREVSH, TROR, TRORs, TRSB, TRSBs, TSBC,
