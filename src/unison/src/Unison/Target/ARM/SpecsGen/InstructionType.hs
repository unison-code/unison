...
instructionType i
  ...
  | i `elem`
      [ABS, ADCri, ADCrr, ADCrsi, ADCrsr, ADDSri, ADDSrr, ADDSrsi,
       ...
       T2ADDri_fi_source_fi, T2ADDrr, T2ADDrs, T2ADR, T2ANDri,
       T2ANDri_cpsr, T2ANDrr, T2ANDrs, T2ASRri, T2ASRrr, T2BFC, T2BFI,
       ...
       T2LSLri, T2LSLrr, T2LSRri, T2LSRrr, T2MCR, T2MCR2, T2MCRR, T2MCRR2,
       T2MLA, T2MLS, T2MOVCCasr, T2MOVCCi, T2MOVCCi16, T2MOVCCi32imm,
       T2MOVCClsl, T2MOVCClsr, T2MOVCCr, T2MOVCCror, T2MOVSsi, T2MOVSsr,
       T2MOVTi16, T2MOVTi16_ga_pcrel, T2MOV_ga_pcrel, T2MOVi, T2MOVi16,
       T2MOVi16_ga_pcrel, T2MOVi16_source, T2MOVi32imm,
       ...
       T2SASX, T2SBCri, T2SBCrr, T2SBCrs, T2SBFX, T2SDIV, T2SEL, T2SETPAN,
       ...
       T2SXTAB, T2SXTAB16, T2SXTAH, T2SXTB, T2SXTB16, T2SXTH, T2TEQri,
       T2TEQrr, T2TEQrr_cpsr, T2TEQrs, T2TSTri, T2TSTri_cpsr, T2TSTrr,
       T2TSTrr_cpsr, T2TSTrs, T2TSTrs_cpsr, T2UADD16, T2UADD8, T2UASX,
       T2UBFX, T2UDF, T2UDIV, T2UHADD16, T2UHADD8, T2UHASX, T2UHSAX,
       T2UHSUB16, T2UHSUB8, T2UMAAL, T2UMLAL, T2UMULL, T2UQADD16,
       T2UQADD8, T2UQASX, T2UQSAX, T2UQSUB16, T2UQSUB8, T2USAD8, T2USADA8,
       T2USAT, T2USAT16, T2USAX, T2USUB16, T2USUB8, T2UXTAB, T2UXTAB16,
       T2UXTAH, T2UXTB, T2UXTB16, T2UXTH, TADC, TADDframe, TADDhirr,
       TADDhirrs, TADDi3, TADDi3s, TADDi8, TADDi8s, TADDrSP, TADDrSPi,
       TADDrr, TADDrrs, TADDspi, TADDspi_pseudo, TADDspr,
       ...
       TMOVCCr_pseudo, TMOVSr, TMOVi8, TMOVi8s, TMOVi8s_source, TMOVr,
       TMUL, TMULz, TMVN, TMVNs, TORR, TORRs, TPICADD, TPOP, TPUSH,
