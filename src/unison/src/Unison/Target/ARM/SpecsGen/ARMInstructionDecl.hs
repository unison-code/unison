...
module Unison.Target.ARM.SpecsGen.ARMInstructionDecl
       (ARMInstruction(..)) where
 
data ARMInstruction = ABS
                    | ADCri
                    | ADCrr
                    | ADCrsi
                    | ADCrsr
                    ...
                    | TMOVi8s_demat
                    | TMOVi8s_remat
                    | T2ADDri_fi_source_fi
                    | T2ADDri_fi_demat_fi
                    | T2ADDri_fi_remat_fi
                    | T2LDRi12_fi_source_fi
                    | T2LDRi12_fi_demat_fi
                    | T2LDRi12_fi_remat_fi
                    | VLDRD_fi_source_fi
                    | VLDRD_fi_demat_fi
                    | VLDRD_fi_remat_fi
                    | T2MVNi_source
                    ...
                    | T2LDRBi12_fi_demat_fi
                    | T2LDRBi12_fi_remat_fi
                    | T2LEApcrel_cpi_source_cpi
                    | T2LEApcrel_cpi_demat_cpi
                    | T2LEApcrel_cpi_remat_cpi
                    | VLDRS_fi_source_fi
                    | VLDRS_fi_demat_fi
                    | VLDRS_fi_remat_fi
                    deriving (Eq, Ord)
