...
parent i
  | i `elem`
      [ABS, ADCri, ADCrr, ADCrsi, ADCrsr, ADDSri, ADDSrr, ADDSrsi,
       ...
       T2ADDri, T2ADDri12, T2ADDri_fi, T2ADDrr, T2ADDrs, T2ADR, T2ANDri,
       T2ANDrr, T2ANDrs, T2ASRri, T2ASRrr, T2B, T2BFC, T2BFI, T2BICri,
       T2BICrr, T2BICrs, T2BR_JT, T2BXJ, T2Bcc, T2CDP, T2CDP2, T2CLREX,
       T2CLZ, T2CMNri, T2CMNzrr, T2CMNzrs, T2CMPri, T2CMPrr, T2CMPrs,
  ...
  | i `elem` [T2STRDi8_linear] = Just T2STRDi8
  | i `elem` [T2STRi12_linear] = Just T2STRi12
