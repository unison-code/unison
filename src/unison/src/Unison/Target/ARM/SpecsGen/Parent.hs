...
parent i
  | i `elem`
      [ABS, ADCri, ADCrr, ADCrsi, ADCrsr, ADDSri, ADDSrr, ADDSrsi,
       ...
       T2ADDSrr, T2ADDSrs, T2ADDri, T2ADDri12, T2ADDri_fi, T2ADDrr,
       T2ADDrs, T2ADR, T2ANDri, T2ANDrr, T2ANDrs, T2ASRri, T2ASRrr, T2B,
       T2BFC, T2BFI, T2BICri, T2BICrr, T2BICrs, T2BR_JT, T2BXJ, T2Bcc,
       T2CDP, T2CDP2, T2CLREX, T2CLZ, T2CMNri, T2CMNzrr, T2CMNzrs,
       T2CMPri, T2CMPrr, T2CMPrs, T2CPS1p, T2CPS2p, T2CPS3p, T2CRC32B,
       T2CRC32CB, T2CRC32CH, T2CRC32CW, T2CRC32H, T2CRC32W, T2DBG,
       T2DCPS1, T2DCPS2, T2DCPS3, T2DMB, T2DSB, T2EORri, T2EORrr, T2EORrs,
       T2HINT, T2HVC, T2ISB, T2IT, T2Int_eh_sjlj_setjmp,
