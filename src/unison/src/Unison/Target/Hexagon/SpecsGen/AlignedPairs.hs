...
alignedPairs i ([_], [_])
  | i `elem`
      [L2_loadrbgp, L2_loadrbgp_ce, L2_loadrdgp, L2_loadrdgp_ce,
       ...
       L2_loadrhgp_source_ce, L2_loadrigp, L2_loadrigp_ce, L2_loadrubgp,
       L2_loadrubgp_ce, L2_loadrubgp_source, L2_loadrubgp_source_ce,
       L2_loadruhgp, L2_loadruhgp_ce, L4_loadrb_abs, L4_loadrb_abs_ce,
...
alignedPairs i ([_], [_])
  | i `elem`
      [A2_abs, A2_abssat, A2_negsat, A2_not, A2_roundsat, A2_sat,
       ...
       L2_loadri_io_fi_remat_fi_ce, L2_loadrubgp_demat,
       L2_loadrubgp_demat_ce, L2_loadrubgp_remat, L2_loadrubgp_remat_ce,
