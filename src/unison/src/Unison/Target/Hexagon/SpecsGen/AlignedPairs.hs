...
alignedPairs i ([_, _], [_])
  | i `elem`
      [A4_cmpbeq, A4_cmpbgt, A4_cmpbgtu, A4_cmpheq, A4_cmphgt,
       ...
       C2_cmpeqp, C2_cmpgt, C2_cmpgtp, C2_cmpgtu, C2_cmpgtup, C4_cmplte,
       C4_cmplteu, C4_cmpneq, C4_nbitsclr, C4_nbitsset, S2_storew_locked,
       S2_tstbit_r, S4_ntstbit_r, S4_stored_locked]
    = []
alignedPairs i ([_, _], [_])
  | i `elem`
...
alignedPairs i ([_, _, _, _], [])
  | i `elem`
      [S2_pstorerbf_io, S2_pstorerbf_io_ce, S2_pstorerbnewf_io,
       ...
       S2_pstorerif_io, S2_pstorerif_io_ce, S2_pstorerinewf_io,
       S2_pstorerinewf_io_ce, S2_pstorerinewt_io, S2_pstorerinewt_io_ce,
       S2_pstorerit_io, S2_pstorerit_io_ce, S4_pstorerbfnew_io,
       S4_pstorerbfnew_io_ce, S4_pstorerbnewfnew_io,
       S4_pstorerbnewfnew_io_ce, S4_pstorerbnewtnew_io,
       S4_pstorerbnewtnew_io_ce, S4_pstorerbtnew_io,
       ...
       S4_pstoreritnew_io, S4_pstoreritnew_io_ce, S4_storerb_ur,
       S4_storerb_ur_ce, S4_storerbnew_ur, S4_storerbnew_ur_ce,
       S4_storerd_ur, S4_storerd_ur_ce, S4_storerf_ur, S4_storerf_ur_ce,
       S4_storerh_ur, S4_storerh_ur_ce, S4_storerhnew_ur,
       S4_storerhnew_ur_ce, S4_storeri_ur, S4_storeri_ur_ce,
       S4_storerinew_ur, S4_storerinew_ur_ce, V6_vS32Ub_npred_ai,
       V6_vS32Ub_npred_ai_128B, V6_vS32Ub_npred_ai_128B_ce,
       V6_vS32Ub_npred_ai_ce, V6_vS32Ub_pred_ai, V6_vS32Ub_pred_ai_128B,
