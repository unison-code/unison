...
\begin{equation}\displaystyle\label{eq:live-end}
  ...
  \operatorname{max}\left(\;\;\;\maximum{\substack{p \in \users{t} \suchThat\\\operandTemporary{p} = t}}{\operationIssueCycle{\operandOperation{p}}}, \temporaryLiveStart{t} + \minimumLiveDuration{t}\right)
  \quad
  \forallIn{t}{\allTemporaries{}}
\end{equation}
}
